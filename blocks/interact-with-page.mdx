...
<Frame caption="Screenshot: Interact with Page block configuration showing a sequence of actions">
  ![Screenshot: Interact with Page block configuration showing a sequence of actions](/blocks/imgs/block-interact-with-page.png)
</Frame>

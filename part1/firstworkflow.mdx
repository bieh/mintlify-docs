...
_[Optional: Insert a screenshot of creating a new workflow]_
...
_[Optional: Insert a screenshot of configuring the Open Websites block]_
...
_[Optional: Insert a screenshot of configuring the Extract Data block for the title]_
...
- Navigate to the results area. You might click on the **Running** status indicator if the workflow is still active, or the **Results** section if it has completed.
- Click on **"View as sheet"**. You should see the extracted data, presented in a table, with a column named `page_title` containing the text "Example Domain".

_[Optional: Insert a screenshot of the results showing the extracted title]_

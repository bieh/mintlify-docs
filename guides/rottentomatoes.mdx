...
Click 'click to set' to open the editor and write the schema in JSON format. Specify the names of the objects for extraction, as well as the most detailed description for each object.  The more detailed the description, the more accurate the extracted data will be. There are two visible critic reviews on the page, so we will add a list designation [ ] for them.

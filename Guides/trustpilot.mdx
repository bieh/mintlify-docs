...
Click 'click to set' to open the editor and write the schema in JSON format. Specify the names of the objects for extraction, as well as the most detailed description for each object.

...
![Get Started Creating A New Workflow Pn](/Get-Started/imgs/Get-Started-Creating-a-new-workflow.png)
</Frame>
...
<Frame caption="Configuring the Open Websites block with example.com">
  ![Get Started Open Websites Block With Example Com Pn](/Get-Started/imgs/Get-Started-Open-Websites-block-with-example.com.png)
</Frame>
...
<Frame caption="Configuring the Extract Data block for page_title">
  ![Get Started Extract Data Block For Page Title Pn](/Get-Started/imgs/Get-Started-Extract-Data-block-for-page_title.png)
</Frame>
...
- Once the workflow finishes (it should be very quick for this example), click on **"View as sheet"**. You should see the extracted data presented in a table, with a column named `page_title` containing the text "Example Domain".

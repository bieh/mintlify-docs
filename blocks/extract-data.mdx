...
* **One Page, One Schema:** The schema defined in one `Extract Data` block applies to the single page the agent is currently on. If you navigate to a different page with a different structure, you'll typically need another `Extract Data` block.
